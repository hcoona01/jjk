const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminDashboard-_oY4h23s.js","assets/mockData-MTF1Wk0d.js","assets/briefcase-DsDd5Fef.js","assets/proxy-DQ77-Mqq.js","assets/refresh-cw-BuPtupgh.js","assets/AdminAnalytics-D1tahOVT.js","assets/MockInterview-CpViqrh_.js","assets/index-Duc0EmRf.js","assets/ResumeEditor-CHKfI32M.js"])))=>i.map(i=>d[i]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        ...
        isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 14, className: "text-primary opacity-60" })
      ]
    }
  );
}
function AdminLayout() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-background overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "w-60 flex-shrink-0 flex flex-col bg-card border-r border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-4 py-5 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { size: 16, className: "text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-bold text-foreground tracking-tight", children: "Nexus" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground leading-none mt-0.5", children: "Placement Portal" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 overflow-y-auto py-3 px-2 space-y-5", children: sections.map(
        (section) => section.items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          section.title && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "px-3 mb-1.5 text-[10px] font-semibold uppercase tracking-widest text-muted-foreground/60", children: section.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5", children: section.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            SidebarLink,
            {
              item,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground/50 text-center", children: [
        "© ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-y-auto bg-background min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
  ] });
}
const AdminDashboard = reactExports.lazy(() => __vitePreload(() => import("./AdminDashboard-_oY4h23s.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const AdminAnalytics = reactExports.lazy(() => __vitePreload(() => import("./AdminAnalytics-D1tahOVT.js"), true ? __vite__mapDeps([5,1,3]) : void 0));
const MockInterview = reactExports.lazy(() => __vitePreload(() => import("./MockInterview-CpViqrh_.js"), true ? __vite__mapDeps([6,7,3,4]) : void 0));
const ResumeEditor = reactExports.lazy(() => __vitePreload(() => import("./ResumeEditor-CHKfI32M.js"), true ? __vite__mapDeps([8,2,3,7,4]) : void 0));
function PlaceholderPage({ title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-64 gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-semibold text-foreground", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "This section is coming soon." })
  ] });
}
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 border-2 border-primary border-t-transparent rounded-full animate-spin" }) });
}
function withSuspense(Component2) {
  return () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Component2, {}) });
}
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}),
  beforeLoad: ({ location: location2 }) => {
...
const adminIndexRoute = createRoute({
  ...
  path: "/",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/admin/dashboard" })
});
...
const usersRoute = createRoute({
  getParentRoute: () => adminRoute,
  path: "users",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderPage, { title: "Placement Training Cell" })
});
const studentsRoute = createRoute({
  getParentRoute: () => adminRoute,
  path: "students",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderPage, { title: "Manage Students" })
});
const companiesRoute = createRoute({
  getParentRoute: () => adminRoute,
  path: "companies",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderPage, { title: "Company Registration" })
});
const settingsRoute = createRoute({
  getParentRoute: () => adminRoute,
  path: "settings",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(PlaceholderPage, { title: "Settings" })
});
